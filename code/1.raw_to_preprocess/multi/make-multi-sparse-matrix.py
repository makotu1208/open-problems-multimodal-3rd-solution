...
convert_h5_to_sparse_csr(raw_path_base + "train_multi_targets.h5", \
                         raw_multi_path + "train_multi_targets")

convert_h5_to_sparse_csr(raw_path_base + "train_multi_targets_raw.h5", \
                         raw_multi_path + "train_multi_raw_targets")

convert_h5_to_sparse_csr(raw_path_base + "train_multi_inputs.h5", \
                         raw_multi_path + "train_multi_inputs")

convert_h5_to_sparse_csr(raw_path_base + "train_multi_inputs_raw.h5", \
                         raw_multi_path + "train_multi_raw_inputs")

convert_h5_to_sparse_csr(raw_path_base + "test_multi_inputs.h5", \
                         raw_multi_path + "test_multi_inputs")

convert_h5_to_sparse_csr(raw_path_base + "test_multi_inputs_raw.h5", \
                         raw_multi_path + "test_multi_raw_inputs")
